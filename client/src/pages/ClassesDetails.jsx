...
const ClassesDetails = () => {
  ...
  const fetchClassDetails = async () => {
    try {
      setLoading(true)
      const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/class/getclassbyid/${classid}`, {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/auth/getuser`, {
  ...
  const handleSubmitPost = async () => {
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/class/addpost`, {
        title: postTitle,
  ...
  const handleJoinRequest = async () => {
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/class/request-to-join`, {
        classroomId: classid,
  ...
  const handleSubmitOtp = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/class/verify-otp`,
        {
          classroomId: classid,
          studentEmail: user?.email,
          otp,
