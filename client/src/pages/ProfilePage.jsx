...
const ProfilePage = () => {
        ...
        const fetchUser = async () => {
            try {
                const response = await axios.get(
                    `${import.meta.env.VITE_API_BASE_URL}/auth/getuser`,
                    {
    ...
    const fetchClassrooms = async () => {
        try {
            const response = await axios.get(
                `${import.meta.env.VITE_API_BASE_URL}/class/classroomscreatedbyme`,
                {
            ...
            if (response.data.ok) {
                setClassroomsCreatedByMe(response.data.data);
            } else {
    ...
    const fetchClassroomsJoinedByMe = async () => {
        try {
            const response = await axios.get(
                `${import.meta.env.VITE_API_BASE_URL}/class/classroomsforstudent`,
                {
                  withCredentials: true, 
                }
              );
            ...
            if (response.data.ok) {
                setClassroomsJoinedByMe(response.data.data);
            }
        }
        catch (error) {
    ...
    const handleCreateClassroom = async () => {
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/class/create`,
                {
                  name: classroomName,
                  description,
                },
